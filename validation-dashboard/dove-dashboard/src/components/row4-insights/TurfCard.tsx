    ...
    <div className="bg-darpan-surface border border-darpan-border rounded-xl p-4" style={{ boxShadow: '0 0 20px rgba(200,255,0,0.03)' }}>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 h-2 bg-darpan-surface rounded-full overflow-hidden">
            <div
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-sm font-bold text-darpan-cyan">
          ...
          {Object.entries(turf.individual_reach)
            ...
            .map(([name, pct]) => (
              <div key={name} className="flex items-center gap-2">
                ...
                <div className="flex-1 h-1.5 bg-darpan-surface rounded-full overflow-hidden">
                  <div
